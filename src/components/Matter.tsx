  ...
  useEffect(() => {
    const init = async () => {
      ...
      const ceiling = Bodies.rectangle(
        window.innerWidth / 2,
        -thickness / 2 - window.innerHeight,
        bigNumber,
        thickness,
        {
          isStatic: true,
      ...
      const floor = Bodies.rectangle(
        window.innerWidth / 2,
        window.innerHeight + thickness / 2.02,
        bigNumber,
        thickness,
        {
          isStatic: true,
      ...
      await createPill('/pills/orange/about.png', scale, window.innerHeight - 100);
      // createPill('/pills/orange/dragMe.png', scale, window.innerHeight - 100);
      Composite.add(engineRef.current.world, [ceiling, floor, left, right, mouseConstraint, ball]);
      Render.run(render);
